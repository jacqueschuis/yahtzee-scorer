const Dice = ({value, newDice}) => {
    return ( 
        <svg onClick={newDice} xmlns="http://www.w3.org/2000/svg" className=" cursor-pointer lg:w-10 w-8 fill-teal-500 dark:fill-blue-300 hover:fill-teal-900 dark:hover:fill-blue-100 transition-all" viewBox="0 0 16 16">
            {
                value === 1 &&
                <>
