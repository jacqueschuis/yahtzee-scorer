            ...
            <Trail>
                    ...
                    <table className="table-auto min-w-full max-w-[1000px] text-center md:text-xl self-start text-blue-900 dark:text-teal-300">
                        ...
                        <tbody>
                            <tr className="dark:text-blue-100 text-teal-900 divide-none font-semibold tracking-wider relative">
                                <td className="text-sm md:text-xl p-2 sticky z-10 left-0 bg-teal-500 dark:bg-blue-700 dark:text-teal-100">ones</td>
                                {playerList.map((player, index) => {
                                    const [isDisabled, setIsDisabled] = useState(false);

                                    return (
                                        <td className={`border-0 border-none outline-none outline-0 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-200 dark:bg-blue-500" : " bg-teal-500 dark:bg-blue-700"}`} key={player.name + "Ones"}>
                                            <input
                                                type="tel"
                                                className={`text-center outline-none w-full h-full p-2 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-200 dark:bg-blue-500" : " bg-teal-500 dark:bg-blue-700"}`}
                                                onBlur={(e) => {
                            ...
                            <tr className="dark:text-blue-100 text-teal-900 divide-none font-semibold tracking-wider relative">
                                <td className="text-sm md:text-xl p-2 sticky z-10 left-0 bg-teal-500 dark:bg-blue-700 dark:text-teal-100">twos</td>
                                {playerList.map((player, index) => {
                                    const [isDisabled, setIsDisabled] = useState(false);

                                    return (
                                        <td className={`border-0 border-none outline-none outline-0 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-300 dark:bg-blue-600" : " bg-teal-500 dark:bg-blue-700"}`} key={player.name + "Twos"}>
                                            <input
                                                type="tel" 
                                                className={`text-center  outline-none w-full h-full p-2 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-300 dark:bg-blue-600" : " bg-teal-500 dark:bg-blue-700"}`} 
                                                onBlur={(e) => {
                            ...
                            <tr className="dark:text-blue-100 text-teal-900 divide-none font-semibold tracking-wider relative">
                                <td className="text-sm md:text-xl p-2 sticky z-10 left-0 bg-teal-500 dark:bg-blue-700 dark:text-teal-100">threes</td>
                                {playerList.map((player, index) => {
                                    const [isDisabled, setIsDisabled] = useState(false);

                                    return (
                                        <td className={`border-0 border-none outline-none outline-0 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-200 dark:bg-blue-500" : " bg-teal-500 dark:bg-blue-700"}`} key={player.name + "Threes"}>
                                            <input
                                                type="tel" 
                                                className={`text-center outline-none w-full h-full p-2 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-200 dark:bg-blue-500" : " bg-teal-500 dark:bg-blue-700"}`} 
                                                onBlur={(e) => {
                            ...
                            <tr className="dark:text-blue-100 text-teal-900 divide-none font-semibold tracking-wider relative">
                                <td className="text-sm md:text-xl p-2 sticky z-10 left-0 bg-teal-500 dark:bg-blue-700 dark:text-teal-100">fours</td>
                                {playerList.map((player, index) => {
                                    const [isDisabled, setIsDisabled] = useState(false);

                                    return (
                                        <td className={`border-0 border-none outline-none outline-0 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-300 dark:bg-blue-600" : " bg-teal-500 dark:bg-blue-700"}`} key={player.name + "Fours"}>
                                            <input
                                                type="tel" 
                                                className={`text-center  outline-none w-full h-full p-2 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-300 dark:bg-blue-600" : " bg-teal-500 dark:bg-blue-700"}`} 
                                                onBlur={(e) => {
                            ...
                            <tr className="dark:text-teal-100 divide-none font-semibold tracking-wider relative">
                                <td className="text-sm md:text-xl p-2 sticky z-10 left-0 bg-teal-500 dark:bg-blue-700 dark:text-teal-100">fives</td>
                                {playerList.map((player, index) => {
                                    const [isDisabled, setIsDisabled] = useState(false);

                                    return (
                                        <td className={`border-0 border-none outline-none outline-0 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-200 dark:bg-blue-500" : " bg-teal-500 dark:bg-blue-700"}`} key={player.name + "Fives"}>
                                            <input
                                                type="tel" 
                                                className={`text-center  outline-none w-full h-full p-2 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-200 dark:bg-blue-500" : " bg-teal-500 dark:bg-blue-700"}`} 
                                                onBlur={(e) => {
                            ...
                            <tr className="dark:text-teal-100 divide-none font-semibold tracking-wider relative">
                                <td className="text-sm md:text-xl p-2 sticky z-10 left-0 bg-teal-500 dark:bg-blue-700 dark:text-teal-100">sixes</td>
                                {playerList.map((player, index) => {
                                    const [isDisabled, setIsDisabled] = useState(false);

                                    return (
                                        <td className={`border-0 border-none outline-none outline-0 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-300 dark:bg-blue-600" : " bg-teal-500 dark:bg-blue-700"}`} key={player.name + "Sixes"}>
                                            <input
                                                type="tel" 
                                                className={`text-center  outline-none w-full h-full p-2 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-300 dark:bg-blue-600" : " bg-teal-500 dark:bg-blue-700"}`} 
                                                onBlur={(e) => {
                            ...
                            <tr className="relative dark:text-blue-100 text-teal-900 font-semibold tracking-wider">
                                <td className="border-0 border-none outline-0 outline-none dark:text-teal-100 p-2 sticky z-10 left-0 dark:bg-blue-600 bg-teal-400">upper</td>
                                {playerList.map((player, index) => {
                                    return (
                                        <td className={`${ turnCount % playerNumber === index? "dark:bg-blue-500 bg-teal-200" : "dark:bg-blue-600 bg-teal-400"}`} key={player.name + "UpperScore"}>
                                            <input disabled className={`text-center w-full h-full p-2 dark:text-blue-900 text-teal-900 ${ turnCount % playerNumber === index? "dark:bg-blue-500 bg-teal-200" : "dark:bg-blue-600 bg-teal-400"}`} value={player.upperScore} />
                                        </td>
                                    )
                                })}
                            </tr>
                ...
                <div className="overflow-auto rounded-3xl h-fit w-full mb-5 shadow-2xl">
                    <table className="table-auto min-w-full max-w-[1000px] text-center md:text-xl self-start text-blue-900 dark:text-teal-300">
                        ...
                        <tbody>
                            <tr className="dark:text-blue-100 text-teal-900 divide-none font-semibold tracking-wider relative">
                                <td className="text-sm md:text-xl p-2 sticky z-10 left-0 bg-teal-500 dark:bg-blue-700 dark:text-teal-100" onClick={() => setThreeKindClick(!threeKindClick)}>{threeKindClick ? "total all" : "3/kind"}</td>
                                {playerList.map((player, index) => {
                                    const [isDisabled, setIsDisabled] = useState(false);

                                    return (
                                        <td className={`border-0 border-none outline-none outline-0 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-200 dark:bg-blue-500" : " bg-teal-500 dark:bg-blue-700"}`} key={player.name+"ThreeKind"}>
                                            <input
                                                type="tel" 
                                                className={`text-center  outline-none w-full h-full p-2 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-200 dark:bg-blue-500" : " bg-teal-500 dark:bg-blue-700"}`} 
                                                onBlur={(e) => {
                            ...
                            <tr className="dark:text-blue-100 text-teal-900 divide-none font-semibold tracking-wider relative">
                                <td className="text-sm md:text-xl p-2 sticky z-10 left-0 bg-teal-500 dark:bg-blue-700 dark:text-teal-100" onClick={() => setFourKindClick(!fourKindClick)}>{fourKindClick ? "total all" : '4/kind'}</td>
                                {playerList.map((player, index) => {
                                    const [isDisabled, setIsDisabled] = useState(false);

                                    return (
                                        <td className={`border-0 border-none outline-none outline-0 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-300 dark:bg-blue-600" : " bg-teal-500 dark:bg-blue-700"}`} key={player.name + "FourOfAKind"}>
                                            <input
                                                type="tel" 
                                                className={`text-center  outline-none w-full h-full p-2 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-300 dark:bg-blue-600" : " bg-teal-500 dark:bg-blue-700"}`} 
                                                onBlur={(e) => {
                            ...
                            <tr className="dark:text-blue-100 text-teal-900 divide-none font-semibold tracking-wider relative">
                                <td className="text-sm md:text-xl p-2 sticky z-10 left-0 bg-teal-500 dark:bg-blue-700 dark:text-teal-100" onClick={() => setFullHouseClick(!fullHouseClick)}>{fullHouseClick ? "25" : "full house"}</td>
                                {playerList.map((player, index) => {
                                    const [isDisabled, setIsDisabled] = useState(false);

                                    return (
                                        <td className={`border-0 border-none outline-none outline-0 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-200 dark:bg-blue-500" : " bg-teal-500 dark:bg-blue-700"}`} key={player.name + "FullHouse"}>
                                            <input
                                                type="tel" 
                                                className={`text-center  outline-none w-full h-full p-2 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-200 dark:bg-blue-500" : " bg-teal-500 dark:bg-blue-700"}`} 
                                                onBlur={(e) => {
                            ...
                            <tr className="dark:text-blue-100 text-teal-900 divide-none font-semibold tracking-wider relative">
                                <td className="text-sm md:text-xl p-2 sticky z-10 left-0 bg-teal-500 dark:bg-blue-700 dark:text-teal-100" onClick={() => setSmStraightClick(!smStraightClick)}>{smStraightClick ? "30" : "sm straight"}</td>
                                {playerList.map((player, index) => {
                                    const [isDisabled, setIsDisabled] = useState(false);

                                    return (
                                        <td className={`border-0 border-none outline-none outline-0 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-300 dark:bg-blue-600" : " bg-teal-500 dark:bg-blue-700"}`} key={player.name + "SmStraight"}>
                                            <input
                                                type="tel" 
                                                className={`text-center  outline-none w-full h-full p-2 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-300 dark:bg-blue-600" : " bg-teal-500 dark:bg-blue-700"}`} 
                                                onBlur={(e) => {
                            ...
                            <tr className="dark:text-blue-100 text-teal-900 divide-none font-semibold tracking-wider relative">
                                <td className="text-sm md:text-xl p-2 sticky z-10 left-0 bg-teal-500 dark:bg-blue-700 dark:text-teal-100" onClick={() => setLgStraightClick(!lgStraightClick)}>{lgStraightClick ? "40" : "lg straight"}</td>
                                {playerList.map((player, index) => {
                                    const [isDisabled, setIsDisabled] = useState(false);

                                    return (
                                        <td className={`border-0 border-none outline-none outline-0 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-200 dark:bg-blue-500" : " bg-teal-500 dark:bg-blue-700"}`} key={player.name + "LgStraight"}>
                                            <input
                                                type="tel" 
                                                className={`text-center outline-none w-full h-full p-2 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-200 dark:bg-blue-500" : " bg-teal-500 dark:bg-blue-700"}`} 
                                                onBlur={(e) => {
                            ...
                            <tr className="dark:text-blue-100 text-teal-900 divide-none font-semibold tracking-wider relative">
                                <td className="text-sm md:text-xl p-2 sticky z-10 left-0 bg-teal-500 dark:bg-blue-700 dark:text-teal-100" onClick={() => setYahtzeeClick(!yahtzeeClick)}>{yahtzeeClick ? "50" : "yahtzee"}</td>
                                {playerList.map((player, index) => {
                                    const [isDisabled, setIsDisabled] = useState(false);

                                    return (
                                        <td className={`border-0 border-none outline-none outline-0 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-300 dark:bg-blue-600" : " bg-teal-500 dark:bg-blue-700"}`} key={player.name + "Yahtzee"}>
                                            <input
                                                type="tel" 
                                                className={`text-center  outline-none w-full h-full p-2 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-300 dark:bg-blue-600" : " bg-teal-500 dark:bg-blue-700"}`} 
                                                onBlur={(e) => {
                            ...
                            <tr className="dark:text-blue-100 text-teal-900 divide-none font-semibold tracking-wider relative">
                                <td className="text-sm md:text-xl p-2 sticky z-10 left-0 bg-teal-500 dark:bg-blue-700 dark:text-teal-100" onClick={() => setChanceClick(!chanceClick)}>{chanceClick ? "total all" : "chance"}</td>
                                {playerList.map((player, index) => {
                                    const [isDisabled, setIsDisabled] = useState(false);

                                    return (
                                        <td className={`border-0 border-none outline-none outline-0 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-200 dark:bg-blue-500" : " bg-teal-500 dark:bg-blue-700"}`} key={player.name + "Chance"}>
                                            <input
                                                type="tel" 
                                                className={`text-center outline-none w-full h-full p-2 ${!isDisabled && turnCount % playerNumber === index ? "bg-teal-200 dark:bg-blue-500" : " bg-teal-500 dark:bg-blue-700"}`} 
                                                onBlur={(e) => {
                            ...
                            <tr className="relative dark:text-blue-100 text-teal-900 font-semibold tracking-wider">
                                <td className="border-0 border-none outline-0 outline-none dark:text-teal-100 p-2 sticky z-10 left-0 dark:bg-blue-600 bg-teal-400">lower</td>
                                {playerList.map((player, index) => {
                                    return (
                                        <td className={`${ turnCount % playerNumber === index? "dark:bg-blue-500 bg-teal-200" : "dark:bg-blue-600 bg-teal-400"}`} key={player.name + "LowerScore"}>
                                            <input disabled className={`text-center w-full h-full p-2 dark:text-blue-900 text-teal-900 ${ turnCount % playerNumber === index? "dark:bg-blue-500 bg-teal-200" : "dark:bg-blue-600 bg-teal-400"}`} value={player.lowerScore} />
                                        </td>
                                    )
                                })}
                            </tr>
                            <tr className="relative font-semibold tracking-wider bg-orange-300 text-orange-900 dark:bg-orange-700 dark:text-orange-100">
                                <td className="p-2 sticky z-10 left-0 uppercase bg-orange-300 dark:bg-orange-700">total</td>
                                {playerList.map((player, index) => {
                                    return (
